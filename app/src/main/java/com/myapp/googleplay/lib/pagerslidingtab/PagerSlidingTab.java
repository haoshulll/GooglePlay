...
package com.myapp.googleplay.lib.pagerslidingtab;
...
public class PagerSlidingTab extends HorizontalScrollView {
	...
	private int indicatorColor = 0xFF0084FF;//指示线的颜色
	...
	private int indicatorHeight = 4;//指示线高度
...
//		canvas.drawRoundRect(rectF,20,20,rectPaint);
		...
		//若想要将选项换成图标，只要实现IconTabProvider接口
